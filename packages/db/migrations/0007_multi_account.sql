...
ALTER TABLE keyword_rules ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_keyword_rules_account ON keyword_rules(account_id);
ALTER TABLE comment_triggers ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_comment_triggers_account ON comment_triggers(account_id);
ALTER TABLE messages ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_messages_account ON messages(account_id);
ALTER TABLE scenarios ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_scenarios_account ON scenarios(account_id);
ALTER TABLE broadcasts ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_broadcasts_account ON broadcasts(account_id);
ALTER TABLE scoring_rules ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_scoring_rules_account ON scoring_rules(account_id);
ALTER TABLE automation_rules ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_automation_rules_account ON automation_rules(account_id);
ALTER TABLE tracked_links ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_tracked_links_account ON tracked_links(account_id);
ALTER TABLE delivery_settings ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_delivery_settings_account ON delivery_settings(account_id);
ALTER TABLE webhook_endpoints ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_webhook_endpoints_account ON webhook_endpoints(account_id);
ALTER TABLE conversion_goals ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_conversion_goals_account ON conversion_goals(account_id);
ALTER TABLE forms ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_forms_account ON forms(account_id);
ALTER TABLE rate_limit_tokens ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_rate_limit_tokens_account ON rate_limit_tokens(account_id);
ALTER TABLE ai_config ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
CREATE INDEX IF NOT EXISTS idx_ai_config_account ON ai_config(account_id);
ALTER TABLE pending_messages ADD COLUMN account_id TEXT NOT NULL DEFAULT 'default' REFERENCES accounts(id);
